...
import type { ArrowParentheses, AttributePosition, Bool, BracketSameLine, BracketSpacing, Expand, FixKind, IndentScriptAndStyle, IndentStyle, IndentWidth, JsTrailingCommas, JsonTrailingCommas, LineEnding, LineWidth, MaxSize, NegatablePredefinedSourceMatcher, NoAccessKeyOptions, NoAriaHiddenOnFocusableOptions, NoAriaUnsupportedElementsOptions, NoAutofocusOptions, NoDistractingElementsOptions, NoHeaderScopeOptions, NoInteractiveElementToNoninteractiveRoleOptions, NoLabelWithoutControlOptions, NoNoninteractiveElementInteractionsOptions, NoNoninteractiveElementToInteractiveRoleOptions, NoNoninteractiveTabindexOptions, NoPositiveTabindexOptions, NoRedundantAltOptions, NoRedundantRolesOptions, NoStaticElementInteractionsOptions, NoSvgWithoutTitleOptions, NormalizedGlob, OperatorLinebreak, QuoteProperties, QuoteStyle, RuleAssistPlainConfiguration, RuleDomainValue, RulePlainConfiguration, SelfCloseVoidElements, Semicolons, SortOrder, UseAltTextOptions, UseAnchorContentOptions, UseAriaActivedescendantWithTabindexOptions, UseAriaPropsForRoleOptions, UseAriaPropsSupportedByRoleOptions, UseButtonTypeOptions, UseFocusableInteractiveOptions, UseGenericFontNamesOptions, UseHeadingContentOptions, UseHtmlLangOptions, UseIframeTitleOptions, UseKeyWithClickEventsOptions, UseKeyWithMouseEventsOptions, UseMediaCaptionOptions, UseSortedPropertiesOptions, WhitespaceSensitivity } from './schema.ts';
